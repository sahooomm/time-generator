...
def generate_random():
    ...
    num_integers = 4
    random_integers = random.sample(range(start, end + 1), num_integers)
    
    return random_integers

#print(generate_random())

random_inte = generate_random()

keys = []
for key, value in subject_teacher_dict.items():
    print(key,value)
    for i in random_inte:
        if(i == value):
            keys.append(key)
...
def fitnessFunction(chromosome):
    ...
    while i < len(option_list):
        ...
        elif option_list[i] == 10:
            da = 1
            sl = 1
            class_sus(chromosome,conflicts,da,sl)
...
def class_sus(week,conflicts,da,sl):
    ...
    for day in week:
            ...
            for i,slot in enumerate(day):
                ...
                for j,sub in enumerate(slot):
                       
                        for value in keys:
                           
                            if(sub == value and i == 0):
